 ...
 <div id="toaster">
    ...
    <script>
        ...
        $(document).ready(function () {
            showToast("Welcome to SportStock User Dashboard!");
        });
    </script>
    <!-- Main content -->
    <main class="main-content">
        <div class="content">
            ...
            <div id="profileModal" class="modal-container">
                ...
                <div class="container">
                    ...
                    <div class="card profile-card">
                        ...
                        <div style="width: 125px; height: 125px; overflow: hidden; border-radius: 50%; position: relative; margin: 0 auto; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
                            <img class="img-circle" src="../pictures/profile<?php echo $uid;?>.jpg" style="width: 100%; height: 100%; object-fit: cover;"></a>
            ...
            <div id="logModal" class="modal-container" style="margin-top: -17px; min-height: 77vh;">
        ...
        function submitBorrowForm() {
            ...
            .then((data) => {
                if (data.success) {
                    ...
                    window.alert("Equipment Borrowed Successfully.");
                    setTimeout(function() {
        ...
        returnYesButton.addEventListener("click", () => {
            ...
            .then(data => {
                 ...
                 console.log("Equipment return successful!");
                    ...
                    window.alert("Equipment Returned Successfully.");
                    setTimeout(function() {
        ...
        editInfoForm.addEventListener("submit", (event) => {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    // Close the modal
                    editInfoModal.style.display = "none";
                    window.alert("Personal Data Updated Successfully.");
                    setTimeout(function() {
                        window.location.href = "user.php";
                    }, 500);
                } else {
